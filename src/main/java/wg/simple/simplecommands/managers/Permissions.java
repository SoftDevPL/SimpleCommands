...
public class Permissions {
    public final Permission normalHomeCountPerm = new Permission("watchTowerGui.utilities.normalHomeCount");
    public final Permission specialHomeCountPerm = new Permission("watchTowerGui.utilities.specialHomeCountPerm");
